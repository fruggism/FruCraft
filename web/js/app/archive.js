/*
 * Cube-Atlas — Archivio: the empire's documents. They live inside the project,
 * and each one exports as a Minecraft written book. The book is built locally
 * by the shared core, so the preview updates as you type with no round trip.
 */

import {
  state, el, escapeHtml, toast, debounce, newId, confirmDialog, download,
  slugify, setStatus, markDirty,
} from './ui-core.js';
